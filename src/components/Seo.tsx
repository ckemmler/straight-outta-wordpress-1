...
const defaultMeta = {
  title: 'Stoppons le commerce cynique des pesticides interdits',
  siteName: 'Stoppons le commerce cynique des pesticides interdits',
  description: 'Stoppons le commerce cynique des pesticides interdits',
  /** Without additional '/' on the end, e.g. https://theodorusclarence.com */
  url: 'https://stop-pesticides.org',
  type: 'website',
  robots: 'follow, index',
  /**
